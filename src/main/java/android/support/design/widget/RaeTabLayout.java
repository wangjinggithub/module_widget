 ...
 * <p>
 * <p>You can also add items to RaeTabLayout in your layout through the use of {@link TabItem}.
 * An example usage is like so:</p>
 * <p>
 * <pre>
 * &lt;android.support.design.widget.RaeTabLayout
 ...
 */
@ViewPager.DecorView
public class RaeTabLayout extends HorizontalScrollView {
    ...
    /**
     * Gravity used to fill the {@link RaeTabLayout} as much as possible. This option only takes effect
    ...
    /**
     * Gravity used to lay out the tabs in the center of the {@link RaeTabLayout}.
     *
     * @see #setTabGravity(int)
     * @see #getTabGravity()
     */
...
//        android.support.v7.widget.ThemeUtils.checkAppCompatTheme(context);
        ...
        // rae attrs
        TypedArray array = context.obtainStyledAttributes(attrs, com.trywang.module_widget.R.styleable.RaeTabLayout);
        mTabStrip.setIndicatorWidth(array.getDimensionPixelSize(com.trywang.module_widget.R.styleable.RaeTabLayout_tabIndicatorWidth, 0));
        array.recycle();
    ...
    /**
     * Returns the current mode used by this {@link RaeTabLayout}.
     *
     * @see #setTabMode(int)
     */
    @Mode
    ...
    /**
     * The one-cancel shop for setting up this {@link RaeTabLayout} with a {@link ViewPager}.
     * <p>
            ...
            if (startLeft != targetLeft || startRight != targetRight) {
                ...
                animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                    public void onAnimationUpdate(ValueAnimator animator) {
                        ...
                        SlidingTabStrip.this.setIndicatorPosition(lerp(startLeft, targetLeft, fraction), lerp(startRight, targetRight, fraction));
                    }
                });
     ...
     * necessary calls back to the provided {@link RaeTabLayout} so that the tab position is
     * kept in sync.
     * <p>
     * <p>This class stores the provided RaeTabLayout weakly, meaning that you can use
     * {@link ViewPager#addOnPageChangeListener(ViewPager.OnPageChangeListener)
     * addOnPageChangeListener(OnPageChangeListener)} without removing the listener and
     * not cause a leak.
     */
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<RaeTabLayout> mTabLayoutRef;
        private int mPreviousScrollState;
        private int mScrollState;

        public TabLayoutOnPageChangeListener(RaeTabLayout tabLayout) {
        ...
        public void onPageScrolled(final int position, final float positionOffset,
            ...
            final RaeTabLayout tabLayout = mTabLayoutRef.get();
            if (tabLayout != null) {
